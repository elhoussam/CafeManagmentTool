...
public class SecurityHandler {
	...
	private String InitSecurityPolicy(String securityPolicy) {
		...
		try {
			...
			Tracking.error(true,"The Security policy does not initialized:"+ ExceptionHandler.getMessage(e));	
			return null ;
		}
	...
	public String LoadSecurityPolicy(String policyPath) {
		try {
			...
			Tracking.error(true,"The Security policy cant setup:"+ ExceptionHandler.getMessage(e));
			return null ;
		}
	}
	/*	String myLocalIp() : 
